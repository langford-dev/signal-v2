...
const ChatPage = ({ navigation, route }) => {
    ...
    }, [contactNumber, myNumber, roomId, allRooms, messages]);
...
//         storage.load({ key: 'phoneNumber' }).then(async (phoneNumber) => {
//             setMyNumber(phoneNumber)
//             console.log(contactNumber, myNumber)
//             // getRoomID()
//             console.log('roomId--->', roomId)

//             await storage.load({ key: roomId }).then(data => {
...
//         });
//         setMessages([])
//         editChatroomsArray('You cleared this room\'s messages')
//         navigation.pop()
//     }
...
//     async function setSavedMessages() {
//         // console.log('roomId--->', roomId)

//         // await storage.save({ key: roomId, data: messages })
//         //     .then(e => { console.log('setSavedMessages') })
//         //     .catch(e => { console.log(e); })
//     }
...
//         const newChatroomsArray = changeRoomPosition(rooms, currentRoomIndex, 0)
//         // storage.save({ key: 'chatrooms', data: newChatroomsArray })
//         saveNewRoom(newChatroomsArray)
//         // console.log('currentRoomIndex', currentRoomIndex)
//     }

//     function saveNewRoom(listArray) {
//         storage.save({ key: 'chatrooms', data: listArray })
//     }
...
//                 <View style={globalStyles.flex}>
//                     <TouchableOpacity onPress={() => { navigation.goBack() }}>
//                         <Icon name='ios-arrow-back-outline' color='#006aee' size={22} />
//                     </TouchableOpacity>
//                     <View style={globalStyles.space20}></View>
//                     <View style={globalStyles.flex}>
//                         <View style={[globalStyles.appBarAvatar, styles.chatPageAvatar]}></View>
...
//                 <View style={globalStyles.flex}>
//                     <TouchableOpacity onPress={() => { actionSheetRef.current?.setModalVisible(); }}>
//                         <Icon name='ellipsis-vertical-outline' color='#006aee' size={20} />
//                     </TouchableOpacity>
//                 </View>
//             </View>
